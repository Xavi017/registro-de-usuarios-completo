...
class __TwigTemplate_3636c2fd805974fc8cbefabe5c7aa9a1e50060470d5a1e47657a3b662bfb84a4 extends Twig_Template
{
    ...
    {
        $__internal_1ed601db73f6c33c2b6d27dafec59cfac0cc995e480e4f4f07038b43d498f1bf = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_1ed601db73f6c33c2b6d27dafec59cfac0cc995e480e4f4f07038b43d498f1bf->enter($__internal_1ed601db73f6c33c2b6d27dafec59cfac0cc995e480e4f4f07038b43d498f1bf_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@WebProfiler/Collector/request.html.twig"));

        $this->parent->display($context, array_merge($this->blocks, $blocks));
        
        $__internal_1ed601db73f6c33c2b6d27dafec59cfac0cc995e480e4f4f07038b43d498f1bf->leave($__internal_1ed601db73f6c33c2b6d27dafec59cfac0cc995e480e4f4f07038b43d498f1bf_prof);
    ...
    {
        $__internal_1417af8f278a2bd0be3cd65479f7a423603d167c69680043298a35d684037018 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_1417af8f278a2bd0be3cd65479f7a423603d167c69680043298a35d684037018->enter($__internal_1417af8f278a2bd0be3cd65479f7a423603d167c69680043298a35d684037018_prof = new Twig_Profiler_Profile($this->getTemplateName(), "block", "toolbar"));
        ...
        if ($this->getAttribute($this->getAttribute(($context["collector"] ?? null), "controller", array(), "any", false, true), "class", array(), "any", true, true)) {
            ...
            if ($this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "controller", array()), "method", array())) {
                ...
                echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->abbrClass($this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "controller", array()), "class", array()));
                echo "</span>
        ...
        // line 19
        echo "    ";
        $context["request_status_code_color"] = (((400 > $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "statuscode", array()))) ? ((((200 == $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "statuscode", array()))) ? ("green") : ("yellow"))) : ("red"));
        // line 20
        echo "    ";
        $context["request_route"] = (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "route", array())) ? ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "route", array())) : ("NONE"));
        // line 21
        echo "    ";
        ob_start();
        // line 22
    ...
    ";
        ...
        // line 47
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@WebProfiler/Collector/request.html.twig", 47)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? $this->getContext($context, "profiler_url")))));
        
        $__internal_1417af8f278a2bd0be3cd65479f7a423603d167c69680043298a35d684037018->leave($__internal_1417af8f278a2bd0be3cd65479f7a423603d167c69680043298a35d684037018_prof);
    ...
    {
        $__internal_9e4873cf657821bd579950e4317b7b42bdb9f1e0b2f3eec5c4f4f0a3d841966b = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_9e4873cf657821bd579950e4317b7b42bdb9f1e0b2f3eec5c4f4f0a3d841966b->enter($__internal_9e4873cf657821bd579950e4317b7b42bdb9f1e0b2f3eec5c4f4f0a3d841966b_prof = new Twig_Profiler_Profile($this->getTemplateName(), "block", "menu"));
...
";
        ...
        $__internal_9e4873cf657821bd579950e4317b7b42bdb9f1e0b2f3eec5c4f4f0a3d841966b->leave($__internal_9e4873cf657821bd579950e4317b7b42bdb9f1e0b2f3eec5c4f4f0a3d841966b_prof);
    ...
    {
        $__internal_b1ad7b1a355b9769d53747f63657b5a24e3703dc4043ae1a4d11ddb0626e6438 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_b1ad7b1a355b9769d53747f63657b5a24e3703dc4043ae1a4d11ddb0626e6438->enter($__internal_b1ad7b1a355b9769d53747f63657b5a24e3703dc4043ae1a4d11ddb0626e6438_prof = new Twig_Profiler_Profile($this->getTemplateName(), "block", "panel"));
    ...
    ";
        // line 60
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestquery", array()), "all", array()))) {
            // line 61
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 61)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestquery", array())));
            // line 62
            echo "    ";
        } else {
            // line 63
    ...
    ";
        // line 70
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestrequest", array()), "all", array()))) {
            // line 71
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 71)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestrequest", array())));
            // line 72
            echo "    ";
        } else {
            // line 73
    ...
    ";
        // line 80
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestattributes", array()), "all", array()))) {
            // line 81
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 81)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestattributes", array())));
            // line 82
            echo "    ";
        } else {
            // line 83
    ...
    ";
        // line 90
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestcookies", array()), "all", array()))) {
            // line 91
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 91)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestcookies", array())));
            // line 92
            echo "    ";
        } else {
            // line 93
    ...
    ";
        // line 100
        $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 100)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestheaders", array())));
        // line 101
        echo "
...
($context["collector"] ?? $this->getContext($context, "collector")), "content", array())) {
    ...
    ";
        // line 114
        $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 114)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "requestserver", array())));
        // line 115
        echo "
    ...
    ";
        // line 118
        $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 118)->display(array("bag" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "responseheaders", array())));
        // line 119
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "sessionmetadata", array()))) {
            // line 123
            echo "    ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Collector/request.html.twig", 123)->display(array("data" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "sessionmetadata", array())));
            // line 124
            echo "    ";
        } else {
            // line 125
    ...
    ";
        // line 132
        if (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "sessionattributes", array()))) {
            // line 133
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Collector/request.html.twig", 133)->display(array("data" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "sessionattributes", array())));
            // line 134
            echo "    ";
        } else {
            // line 135
    ...
    ";
        // line 142
        if (twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "flashes", array()))) {
            // line 143
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Collector/request.html.twig", 143)->display(array("data" => $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "flashes", array())));
            // line 144
            echo "    ";
        } else {
            // line 145
    ...
    ";
        ...
        ";
            // line 153
            $this->loadTemplate("@WebProfiler/Profiler/bag.html.twig", "@WebProfiler/Collector/request.html.twig", 153)->display(array("bag" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["profile"] ?? $this->getContext($context, "profile")), "parent", array()), "getcollector", array(0 => "request"), "method"), "requestattributes", array())));
            // line 154
            echo "    ";
        }
        // line 155
...
";
        ...
        $__internal_b1ad7b1a355b9769d53747f63657b5a24e3703dc4043ae1a4d11ddb0626e6438->leave($__internal_b1ad7b1a355b9769d53747f63657b5a24e3703dc4043ae1a4d11ddb0626e6438_prof);
...
{% endblock %}
", "@WebProfiler/Collector/request.html.twig", "C:\\wamp64\\www\\votantes1\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\request.html.twig");
    }
}
